...
const superHeroIds =
  "1009368,1009220,1010744,1009664,1009351,1009697,1009663,1009189,1017300,1011054,1009187,1009338";
const {
  data: marvelData,
  isLoading,
  isFetching,
  isPending,
} = await useFetchMarvelData(superHeroIds);
        ...
        <v-card :to="`${menu.marvel.link}/${item.id}`" class="h-100">
          <div class="image-container">
            ...
            <NuxtPicture
              ...
              :img-attrs="{ class: 'img-fit', alt: item.name }"
            />
          </div>
