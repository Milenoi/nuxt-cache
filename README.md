...
NUXT_NASA_API_KEY=YOUR_NASA_API_KEY [Get it here](https://api.nasa.gov/)<br>
NUXT_REDIS_PASSWORD=YOUR_REDIS_PASSWORD [Get it here](https://redis.io/try-free/)<br>
NUXT_REDIS_PORT=YOUR_REDIS_PORT [Get it here](https://redis.io/try-free/)<br>
NUXT_REDIS_HOST=YOUR_REDIS_HOST [Get it here](https://redis.io/try-free/)<br>
NUXT_REDIS_USERNAME=YOUR_REDIS_USERNAME [Get it here](https://redis.io/try-free/)
